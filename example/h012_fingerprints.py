...
from mftools.fingerprints import get_dict, learn_labeling, get_fingerprints_h012
...
if __name__ == '__main__':
    ...
    fingerprints = get_fingerprints_h012(INPUT_PATH, micro_list, kmeans, FEATURE_GENERATOR, ORDER, CNN)
